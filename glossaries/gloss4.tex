\begin{glossarymc}[Cambridge 6]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 1]
            ...
            \begin{ExplainCard}{headbanger}[n][B2]
            ...
            \begin{ExplainCard}{choreographer}[n][B2]
            ...
            \begin{ExplainCard}{be cut out for / be cut out to be}[phr.\ v][B2]
            ...
            \begin{ExplainCard}{have two left feet}[idiom][B2]
            ...
            \begin{ExplainCard}{spring to (one’s) mind}[phrase][B2]
            ...
            \begin{ExplainCard}{make a name for oneself}[idiom][B2]
            ...
            \begin{ExplainCard}{grab hold of}[phrase][B2]
            ...
            \begin{ExplainCard}{grow in popularity}[phrase][C1]
            ...
            \begin{ExplainCard}{partake in}[v][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 2]
            ...
            \begin{ExplainCard}{well-built}[adj][B2]
            ...
            \begin{ExplainCard}{work out}[phr.v][B2]
            ...
            \begin{ExplainCard}{take pride in (sth)}[phrase][B2]
            ...
            \begin{ExplainCard}{be like two peas in a pod}[idiom][B2]
            ...
            \begin{ExplainCard}{get on (well) (with sb)}[phr.v][B2]
            ...
            \begin{ExplainCard}{fall out (with sb)}[phr.v][B2]
            ...
            \begin{ExplainCard}{crack (someone) up}[phr.v][B2]
            ...
            \begin{ExplainCard}{look on the bright side}[idiom][B2]
            ...
            \begin{ExplainCard}{be made for each other}[idiom][B2]
            ...
            \begin{ExplainCard}{fervent}[adj][B2]
            ...
            \begin{ExplainCard}{in a pickle}[idiom][B2]
            ...
            \begin{ExplainCard}{and the like(s)}[phrase][B2]
    ...
    \end{qa}
        ...
        \begin{ExplainCard}{physical appearance}[n][C1]
        ...
        \begin{ExplainCard}{resemblance}[n][C1]
        ...
        \begin{ExplainCard}{lineage}[n][B2]
        ...
        \begin{ExplainCard}{my mind is a blank}[idiom][B2]
        ...
        \begin{ExplainCard}{scientifically proven}[adj][B2]
        ...
        \begin{ExplainCard}{phenomenon}[n][B2]
        ...
        \begin{ExplainCard}{be a spitting image (of)}[idiom][B2]
        ...
        \begin{ExplainCard}{upbringing}[n][B2]
        ...
        \begin{ExplainCard}{a troubled childhood}[phrase][B2]
        ...
        \begin{ExplainCard}{self-centeredness}[n][B2]
        ...
        \begin{ExplainCard}{concern oneself with}[phr.v][B2]
        ...
        \begin{ExplainCard}{theoretical}[adj][B2]
        ...
        \begin{ExplainCard}{mundane}[adj][B2]
        ...
        \begin{ExplainCard}{read up on}[phr.v][B2]
        ...
        \begin{ExplainCard}{none the wiser}[idiom][B2]
        ...
        \begin{ExplainCard}{apparent}[adj][B2]
        ...
        \begin{ExplainCard}{in-depth}[adj/adv][B2]
        ...
        \begin{ExplainCard}{official documents}[n][B2]
        ...
        \begin{ExplainCard}{relevance (to)}[n][B2]
        ...
        \begin{ExplainCard}{flick through}[phr.v][B2]
        ...
        \begin{ExplainCard}{genetic-related diseases}[phrase][B2]
        ...
        \begin{ExplainCard}{hypothesis}[n][B2]
        ...
        \begin{ExplainCard}{fatal}[adj][B2]
        ...
        \begin{ExplainCard}{constraint}[n][B2]
        ...
        \begin{ExplainCard}{allocate}[v][B2]
        ...
        \begin{ExplainCard}{private-funded research}[phrase][B2]
    ...
    \end{qa}
        ...
        \begin{ExplainCard}{music to my ears}[idiom][B2]
        ...
        \begin{ExplainCard}{enthused (about/over)}[adj/v][B2]
        ...
        \begin{ExplainCard}{transition (from A to B)}[n][B2]
        ...
        \begin{ExplainCard}{kill time}[idiom][B2]
        ...
        \begin{ExplainCard}{pressed for (time/money/space)}[adj][B2]
        ...
        \begin{ExplainCard}{standing ovation}[n][C1]
        ...
        \begin{ExplainCard}{an uphill task}[idiom][B2]
        ...
        \begin{ExplainCard}{prevalent}[adj][B2]
        ...
        \begin{ExplainCard}{go off (sth)}[phr.v][B2]
    ...
    \end{qa}
        ...
        \begin{ExplainCard}{by chance}[phrase][C1]
        ...
        \begin{ExplainCard}{life expectancy}[n][B2]
        ...
        \begin{ExplainCard}{carry out}[phr.v][B2]
        ...
        \begin{ExplainCard}{come as a surprise (to sb)}[phrase][B2]
        ...
        \begin{ExplainCard}{rich in (sth)}[adj phrase][B2]
        ...
        \begin{ExplainCard}{antioxidant}[n/adj][B2]
        ...
        \begin{ExplainCard}{serve/act as a shield (against)}[phrase][B2]
        ...
        \begin{ExplainCard}{handsome}[adj][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 3]
            ...
            \begin{ExplainCard}{get lean}[phr.v][B2]
            ...
            \begin{ExplainCard}{hit the gym}[phrase][B2]
            ...
            \begin{ExplainCard}{a wide range (of)}[phrase][B2]
            ...
            \begin{ExplainCard}{leisurely stroll}[n][B2]
            ...
            \begin{ExplainCard}{take delight in}[phrase][B2]
            ...
            \begin{ExplainCard}{workout}[n][B2]
            ...
            \begin{ExplainCard}{strengthen}[v][B2]
            ...
            \begin{ExplainCard}{digestive}[adj][C1]
            ...
            \begin{ExplainCard}{cardiovascular}[adj][B2]
            ...
            \begin{ExplainCard}{relieve}[v][B2]
            ...
            \begin{ExplainCard}{oversimplified}[adj][B2]
            ...
            \begin{ExplainCard}{lapse into a sedentary lifestyle}[phrase][B2]
            ...
            \begin{ExplainCard}{contend}[v][B2]
            ...
            \begin{ExplainCard}{as a last resort}[phrase][B2]
            ...
            \begin{ExplainCard}{the fast pace of life}[phrase][B2]
            ...
            \begin{ExplainCard}{deprive (sb) of (sth)}[v][B2]
            ...
            \begin{ExplainCard}{culprit}[n][B2]
            ...
            \begin{ExplainCard}{deteriorating}[adj][B2]
            ...
            \begin{ExplainCard}{for the sake of}[phrase][B2]
            ...
            \begin{ExplainCard}{promote}[v][B2]
            ...
            \begin{ExplainCard}{destructive}[adj][C1]
            ...
            \begin{ExplainCard}{a whole bunch (of)}[phrase][B2]
            ...
            \begin{ExplainCard}{heighten}[v][B2]
            ...
            \begin{ExplainCard}{equip (sb) with (sth)}[v][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 1]
            \begin{ExplainCard}{bulky}[adj][B2]
            ...
            \begin{ExplainCard}{jam-packed (with)}[adj][B2]
            ...
            \begin{ExplainCard}{thread one’s way (through)}[phr.v][B2]
            ...
            \begin{ExplainCard}{bumper-to-bumper}[adj/adv][B2]
            ...
            \begin{ExplainCard}{strenuous}[adj][B2]
            ...
            \begin{ExplainCard}{accountable (for)}[adj][B2]
            ...
            \begin{ExplainCard}{prevalence (of)}[n][B2]
            ...
            \begin{ExplainCard}{thorniest}[adj][B2]
            ...
            \begin{ExplainCard}{unresolved}[adj][B2]
            ...
            \begin{ExplainCard}{gridlock}[n][B2]
            ...
            \begin{ExplainCard}{in a rush}[idiom][B2]
            ...
            \begin{ExplainCard}{mobbed}[adj][B2]
            ...
            \begin{ExplainCard}{run the risk (of)}[phrase][B2]
            ...
            \begin{ExplainCard}{thoroughfare}[n][B2]
            ...
            \begin{ExplainCard}{dread}[v/n][B2]
            ...
            \begin{ExplainCard}{bronchitis}[n][B2]
            ...
            \begin{ExplainCard}{proneness (to)}[n][B2]
            ...
            \begin{ExplainCard}{surface}[v][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 2]
            \begin{ExplainCard}{run in the family}[idiom][B2]
            ...
            \begin{ExplainCard}{be a breeze}[idiom][B2]
            ...
            \begin{ExplainCard}{ignite (one’s) passion (for)}[phrase][B2]
            ...
            \begin{ExplainCard}{in my neck of the woods}[idiom][B2]
            ...
            \begin{ExplainCard}{stroke (swimming)}[n][B2]
            ...
            \begin{ExplainCard}{in a panic}[phrase][B2]
            ...
            \begin{ExplainCard}{coordinate with}[v][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 3]
            ...
            \begin{ExplainCard}{infiltrate into every nook and cranny}[idiom][B2]
            ...
            \begin{ExplainCard}{substitute (for)}[v][B2]
            ...
            \begin{ExplainCard}{video game console}[n][B2]
            ...
            \begin{ExplainCard}{inseparable (from)}[adj][B2]
            ...
            \begin{ExplainCard}{thriving}[adj][B2]
            ...
            \begin{ExplainCard}{cognitive development}[n][C1]
            ...
            \begin{ExplainCard}{gaming addiction}[n][C1]
            ...
            \begin{ExplainCard}{trigger}[v][B2]
            ...
            \begin{ExplainCard}{great anguish}[n][B2]
            ...
            \begin{ExplainCard}{youngsters}[n][B2]
            ...
            \begin{ExplainCard}{something (that …)}[pron][B2]
            ...
            \begin{ExplainCard}{encounter (stress/problems)}[v][B2]
            ...
            \begin{ExplainCard}{simulate obstacles}[phrase][B2]
            ...
            \begin{ExplainCard}{critical thinking}[n][B2]
            ...
            \begin{ExplainCard}{contributing to}[phrase][B2]
            ...
            \begin{ExplainCard}{formative years}[n][B2]
            ...
            \begin{ExplainCard}{prone (to)}[adj][B2]
            ...
            \begin{ExplainCard}{parental supervision}[n][C1]
            ...
            \begin{ExplainCard}{different walks of life}[idiom][B2]
            ...
            \begin{ExplainCard}{consolidate (interpersonal) support/relationships}[v][B2]
            ...
            \begin{ExplainCard}{be rooted in}[phr][B2]
            ...
            \begin{ExplainCard}{prerequisite}[n][B2]
            ...
            \begin{ExplainCard}{fight tooth and nail}[idiom][B2]
            ...
            \begin{ExplainCard}{a wide variety (of)}[phrase][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 1]
            ...
            \begin{ExplainCard}{fair-weather friend}[n][B2]
            ...
            \begin{ExplainCard}{turn one’s back on (sb/sth)}[idiom][B2]
            ...
            \begin{ExplainCard}{leave (sb) in the lurch}[idiom][B2]
            ...
            \begin{ExplainCard}{(have) a little chit-chat}[phrase][B2]
            ...
            \begin{ExplainCard}{go through}[phr.v][B2]
            ...
            \begin{ExplainCard}{lend a sympathetic ear (to sb)}[idiom][B2]
            ...
            \begin{ExplainCard}{jog one’s memory}[idiom][B2]
            ...
            \begin{ExplainCard}{derive (sth) from (sth)}[v][B2]
            ...
            \begin{ExplainCard}{full-fledged}[adj][B2]
            ...
            \begin{ExplainCard}{gain (someone’s) trust}[phrase][B2]
            ...
            \begin{ExplainCard}{stick by (sb)}[phr.v][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 2]
            ...
            \begin{ExplainCard}{(come) fresh out of university}[phrase][C1]
            ...
            \begin{ExplainCard}{a tall order}[n][B2]
            ...
            \begin{ExplainCard}{economic recession}[n][C1]
            ...
            \begin{ExplainCard}{go belly-up}[idiom][B2]
            ...
            \begin{ExplainCard}{undertake more responsibilities}[v][B2]
            ...
            \begin{ExplainCard}{the crux of the matter}[n][B2]
            ...
            \begin{ExplainCard}{relocate}[v][B2]
            ...
            \begin{ExplainCard}{sit pretty}[idiom][B2]
            ...
            \begin{ExplainCard}{be in two minds (about)}[phrase][B2]
            ...
            \begin{ExplainCard}{pick sb’s brain(s)}[idiom][B2]
            ...
            \begin{ExplainCard}{touch and go}[idiom/adj][B2]
            ...
            \begin{ExplainCard}{on second thought(s)}[phrase][B2]
            ...
            \begin{ExplainCard}{promotion opportunities}[n][B2]
            ...
            \begin{ExplainCard}{further study}[n][B2]
            ...
            \begin{ExplainCard}{overwhelmingly (support)}[adv/phrase][B2]
            ...
            \begin{ExplainCard}{have cold feet}[idiom][B2]
    ...
    \end{qa}
        ...
        \begin{VocabExplain}[Part 3]
            \begin{ExplainCard}{carefree childhood}[n phrase][B2]
            ...
            \begin{ExplainCard}{as easy as falling off a log}[idiom][B2]
            ...
            \begin{ExplainCard}{vague}[adj][B2]
            ...
            \begin{ExplainCard}{dissimilar}[adj][B2]
            ...
            \begin{ExplainCard}{have (one’s) voice (in)}[phrase][B2]
            ...
            \begin{ExplainCard}{down the road}[idiom][B2]
            ...
            \begin{ExplainCard}{a problem shared is a problem halved}[proverb][B2]
            ...
            \begin{ExplainCard}{comprehensible}[adj][B2]
            ...
            \begin{ExplainCard}{daunting task}[collocation][B2]
            ...
            \begin{ExplainCard}{enlist the help (of)}[phrase][B2]
            ...
            \begin{ExplainCard}{sound advice}[collocation][B2]
            ...
            \begin{ExplainCard}{lend a sympathetic ear}[idiom][B2]
            ...
            \begin{ExplainCard}{daily necessities}[collocation][B2]
            ...
            \begin{ExplainCard}{meet the deadlines}[phrase][B2]
            ...
            \begin{ExplainCard}{have so much on (one’s) plate}[idiom][B2]
            ...
            \begin{ExplainCard}{overwhelmed}[adj][B2]
            ...
            \begin{ExplainCard}{minimalist lifestyle}[n phrase][B2]
            ...
            \begin{ExplainCard}{free up}[v][B2]
            ...
            \begin{ExplainCard}{it goes without saying}[idiom][B2]
            ...
            \begin{ExplainCard}{bored to death}[idiom][B2]
                \EN{extremely bored.}
            ...
            \begin{ExplainCard}{sheer}[adj][B2]
            ...
            \begin{ExplainCard}{a sense of demotivation}[n phrase][C1]
            ...
            \begin{ExplainCard}{dissuade (sb) from (doing)}[v][B2]
            ...
            \begin{ExplainCard}{(act/step) beyond one’s comfort zone}[phrase][B2]
            ...
            \begin{ExplainCard}{a myriad of choices}[n phrase][B2]
            ...
            \begin{ExplainCard}{holiday destination}[n][C1]
            ...
            \begin{ExplainCard}{precursor (to/of)}[n][B2]
